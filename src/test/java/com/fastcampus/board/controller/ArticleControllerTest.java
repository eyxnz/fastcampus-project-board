...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "eyxnzTest", setupBefore = TestExecutionEvent.TEST_EXECUTION) // 실제 유저 정보가 필요
    ...
    @WithUserDetails(value = "eyxnzTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
